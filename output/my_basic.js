...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'my_basic.wast';
  var wasmBinaryFile = 'my_basic.wasm';
  var asmjsCodeFile = 'my_basic.temp.asm.js';
...
Module['wasmTableSize'] = 1923;

Module['wasmMaxTableSize'] = 1923;
...
var _eval = Module["_eval"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_eval"].apply(null, arguments) };
